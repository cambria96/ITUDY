                ...
                for(var x = 0; x<positions.length; x++){
                    ...
                    for(var y=0; y<userClass.length; y++){
                        ...
                        if(positions[x].content_id == userClass[y].id){
                            ...
                            $("#member"+userClass[y].id).append("<li><span class ='marginleft'>"+number+"</span><span class='conditionList marginleft'>"+templist[x]+"</span>"+"(<span class='currentnum'>"+currentnum+"</span><span>/</span><span>"+positions[x].number+"</span>)"+"</li> <li><span >▶</span></li>");
                            temparr=[];
